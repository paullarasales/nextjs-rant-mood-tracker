  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-8 text-gray-800 sans">Mood & Rant Tracker</h1>

        <div className="grid grid-cols-1 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200 transition-transform duration-300 hover:scale-105">
            <h2 className="text-2xl font-semibold text-gray-700 mb-6 sans">Rant Journal</h2>
